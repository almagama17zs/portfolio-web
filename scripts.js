...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Inicializamos listas visibles al cargar
  ...
  subblocks.forEach(sb => {
    ...
    header.addEventListener('click', () => {
      // Cerramos todos los subbloques excepto el actual
      ...
      if(isOpen && content){
        ...
        // Iniciamos typewriter para cada <p>
