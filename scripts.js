...
document.addEventListener("DOMContentLoaded", () => {
  ...
  subblocks.forEach(sb => {
    ...
    const typewriterParas = sb.querySelectorAll(".typewriter p");
        ...
        if (list) {
          ...
          list.querySelectorAll("li").forEach((li, i) => {
            ...
            setTimeout(() => {
              li.style.opacity = 1;
              li.style.transform = "translateY(0)";
            }, 80 * i); // animación escalonada
          });
        }

        // Escribir typewriter
        typewriterParas.forEach((p, idx) => {
          p.innerText = "";
          setTimeout(() => typeWriterElement(p, 28), 100 + idx * 150);
        });
